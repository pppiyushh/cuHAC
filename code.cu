...
#define AVERAGE_LINKAGE  'a' // select average distance
#define CENTROID_LINKAGE 't' // select distance between cluster centroids 
#define COMPLETE_LINKAGE 'c' // select maximum distance 
#define SINGLE_LINKAGE   's' // select minimum distance 
